...
public class UpcomingAppointment extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try (PrintWriter pw = response.getWriter()) {
			...
			if (request.getDispatcherType().name().equals("FORWARD"))
				pw.print("<h3> Appointment Booked !!!!<h3>");
			...
			pw.print(
					"<table ><tr style='border:2px; solid'><th>Id</th><th>PID</th><th>Email</th><th>Password</th></tr></table>");
