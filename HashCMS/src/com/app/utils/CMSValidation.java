...
public class CMSValidation {
	...
	public static void ChkdupEmail(String email, Map<String, Customer> list) throws CMSException {
	...
	public static ServicePlan parsenValidateServicePlanCharages(String serviceplan, Double regamount)
			throws CMSException {
		// Parse the input
	...
	public static Customer validateCustomerInputs(String firstname, String lastname, String emailid, String password,
			double regAmount, String dobDate, String plan, Map<String, Customer> list) throws CMSException {
